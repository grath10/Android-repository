...
public class CustomDatePicker {
    ...
    private int scrollUnits = SCROLL_TYPE.HOUR.value;
    ...
    public void setIsLoop(boolean isLoop) {
        if (canAccess) {
            this.year_pv.setLoop(isLoop);
            this.month_pv.setLoop(isLoop);
            this.day_pv.setLoop(isLoop);
            this.hour_pv.setLoop(isLoop);
            this.minute_pv.setLoop(isLoop);
        }
    }
