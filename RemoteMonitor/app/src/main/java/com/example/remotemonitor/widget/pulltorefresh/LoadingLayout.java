package com.example.remotemonitor.widget.pulltorefresh;
...
import com.example.remotemonitor.widget.pulltorefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout {
     ...
     * 正在在上拉或下拉时的状态处理
     *
     * @param scaleOfLayout 拉动距离相较于本身高（宽）度的比例
     */
